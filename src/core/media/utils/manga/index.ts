...
import { MangaProps, MediaResponse, Description, Title } from "../../../../types";
import { Models } from "node-appwrite";

export class Manga {

    private _data: MangaProps | undefined = undefined;

    public set(params: MediaResponse & Models.Document) {
        try {

            if (params.type && params.type !== "MANGA") throw new YoruError({
                name: "TYPE_ERROR",
                code: 400,
    ...
    public setManually(params: MangaProps) {
        try {
